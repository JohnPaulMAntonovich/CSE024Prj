...
Color ColorSelector::getColor() const {
    if (color == RED) {
        ...
        return Color(255/255.0, 0/255.0, 127/255.0);
    }
    else if (color == YELLOW) {
        return Color(255/255.0, 0/255.0, 255/255.0);
    }
    else if (color == GREEN) {
        ...
        return Color(75/255.0, 130/255.0, 0/255.0);
    }
    else if (color == VIOLET) {
        return Color(148/255.0, 211/255.0, 0/255.0);
    }
    else {
        return Color();
    }
...
ColorSelector::ColorSelector(int x, int y, int w, int h) : Group(x, y, w, h) {
    ...
    orangeButton = new Button(x, y + 50, 50, 50, "");
    yellowButton = new Button(x, y + 100, 50, 50, "");
    greenButton = new Button(x, y + 150, 50, 50, "");
    blueButton = new Button(x, y + 200, 50, 50, "");
    indigoButton = new Button(x, y + 250, 50, 50, "");
    violetButton = new Button(x, y + 300, 50, 50, "");
